...
import styles from './RegisterOrganizer.module.scss';
import api from '@api';
      ...
      <Hero.Right background={'background'}>
        <Card className={styles.register}>
          <Form
            ...
            validate={validate} //
          >
            <h2 className={styles.label}>Registrati come organizzatore</h2>

            <div className={styles.inputGroup}>
              <Input label="Nome" name="name" type="text" required size="md" />
              <Input label="Cognome" name="surname" type="text" required size="md" />
            </div>
            ...
            <div className={styles.inputGroup}>
              ...
              <Input label="Confirma password" name="passwordConfirm" type="password" required size="md" />
            </div>
